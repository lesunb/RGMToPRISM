...
import br.unb.cic.rtgoretoprism.generator.goda.producer.RTBPMNProducer;
 ...
 * @author bertolini
 */
public class BPMNGenerationAction extends AbstractCodeGeneractionAction {
	private IWorkbenchWindow window;
	
	/**
	 * Creates a new KLCodeGenerationAction instance
	 */
	public BPMNGenerationAction() {
		super();
	}
	/**
        	...
        	/*	ps.busyCursorWhile( new IRunnableWithProgress() {
        		public void run( IProgressMonitor monitor )
					...
					try {*/
						...
						RTBPMNProducer producer = new RTBPMNProducer(selectedActors, selectedGoals, sourceFolder, targetFolder, false );
						producer.run();
